...
<%
        ...
        try {
            ...
            String sql = "INSERT INTO profile (DOB, Gender, Caste, Physical_Disability, Present_Address, Permanent_Address, " +
            ...
            if (rows > 0) {
                out.println("<p>Profile submitted successfully!</p>");
            } else {
                out.println("<p>Failed to submit profile.</p>");
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    %>
    <a href="profileForm.jsp">Go back to the form</a>
</body>
</html>
</body>
</html>